<template>
    <header class="header-area" style="height:9999px;">
                        ...
                        <div class="col-lg-3">
                            <div class="header-menu-vertical">
                                ...
                                <ul class="menu-content menu-expand">
                                    ...
                                    <li class="menu-item" style="display: none;"><a href="shop-left-sidebar.html">Games &amp; Consoles</a></li>
                                <li class="expand"><a href="javascript:;"><span><i class="ion-android-add"></i>More Categories</span></a></li></ul> <!-- menu content -->
            ...
            <div class="mobile-off-canvas-menu">
                <div class="mobile-canvas-menu-top">
                    ...
                    <ul class="mobile-canvas">
                        <li>
                            <div class="dropdown dropdown-mobile menu-item-has-children"><span class="menu-expand"></span>
                ...
                <div class="mobile-main-menu">
                    <ul class="menu-content">
                        <li class="menu-item-has-children active"><span class="mobile-menu-expand"></span><a href="#">Home <i class="fal fa-chevron-down"></i></a>
                        ...
                        <li><a href="about.html">About</a></li>
                        <li class="menu-item-has-children"><span class="mobile-menu-expand"></span><a href="#">Pages <i class="fal fa-chevron-down"></i></a>
                            <ul class="sub-menu" style="display: none;">
                                <li><a href="about.html">About</a></li>
                                <li><a href="cart.html">cart</a></li>
                                <li><a href="checkout.html">Checkout</a></li>
                        ...
                        <li class="menu-item-has-children"><span class="mobile-menu-expand"></span><a href="#">Shop <i class="fal fa-chevron-down"></i></a>
                            <ul class="mega-sub-menu" style="display: none;">
                                <li class="menu-item-has-children"><span class="mobile-menu-expand"></span>
                                    <a class="menu-title" href="#">Shop Grid</a>
                                    <ul class="submenu-item" style="display: none;">
                                        <li><a href="shop-3-column.html">Shop Grid Column 3</a></li>
                                        <li><a href="shop-4-column.html">Shop Grid Column 4</a></li>
                                        <li><a href="shop-left-sidebar.html">Shop Grid left sidebar</a></li>
                                        <li><a href="shop-right-sidebar.html">Shop Grid Right sidebar</a></li>
                        ...
                        <li class="menu-item-has-children"><span class="mobile-menu-expand"></span><a href="#">Blog <i class="fal fa-chevron-down"></i></a>
                            <ul class="sub-menu" style="display: none;">
                                <li class="menu-item-has-children"><span class="mobile-menu-expand"></span><a href="#">Blog Grid <i class="fal fa-chevron-right"></i></a>
                                    <ul class="sub-menu" style="display: none;">
                                        <li><a href="blog-grid-left-sidebar.html">Blog Grid Left Slider</a></li>
                                        <li><a href="blog-grid-right-sidebar.html">Blog Grid Right Slider</a></li>
                                    </ul>
...
    },
    methods: {
        handleScroll() {
            var scroll = Math.floor(document.body.scrollTop || document.documentElement.scrollTop || window.pageXOffset)
           try {
             if (scroll < 350) {
                
                this.$refs.headermenu.classList = ['header-menu'];
            } else{
                
                this.$refs.headermenu.classList = ['header-menu','sticky'];
            }
           } catch (error) {
               console.log(error);
             this.destroyed();   
